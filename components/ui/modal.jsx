...
export default function Modal({ isOpen, onClose, onSave }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="rounded-2xl p-6 w-full max-w-md shadow-lg bg-slate-900 border border-[#0CAFF0]/30">
                <h1 className="text-2xl font-bold mb-4 text-[#52F2ED]">Nova tarefa</h1>
                    <div className="space-y-4">
                        ...
                        <textarea
                            ...
                            className="mb-3 w-full rounded-lg border border-[#0CAFF0]/30 bg-[#020617] px-3 py-2 text-white h-24"
                        ...
                        <input
                            ...
                            className="mb-3 w-full rounded-lg border border-[#0CAFF0]/30 bg-[#020617] px-3 py-2 text-white"
                            placeholder="Prazo"
                        />
                    </div>
                <button
