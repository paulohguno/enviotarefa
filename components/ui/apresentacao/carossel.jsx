...
const CARD_W = 180;
const CARD_H = 240;
const RADIUS = 400; // Ajustado para ser largo, mas sem cortar nas laterais
            ...
            >
                <div
                    ...
                    style={{
                        ...
                        width: '100%',
                        height: cardH * 2, // Espaço maior para não cortar em cima/baixo
                    }}
                >
                    <div
                        ref={wheelRef}
                        ...
                        style={{
                            ...
                            position: 'absolute',
                            left: '50%',
                            top: '70%', // Posiciona o centro do carrossel mais para baixo
                            marginLeft: -cardW / 2,
                            marginTop: -cardH / 2,
                        }}
                    >
